...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 win32-x64 node-v20.9.0
...
_See code: [dist/commands/hello/index.ts](https://github.com/codewithrt/mynewcli/blob/v0.0.0/dist/commands/hello/index.ts)_
...
_See code: [dist/commands/hello/world.ts](https://github.com/codewithrt/mynewcli/blob/v0.0.0/dist/commands/hello/world.ts)_
